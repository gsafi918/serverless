...
namespace Compan.Function
{
    public static class GetRatingsFunctions
    {
        ...
        public static IActionResult GetRatings(
            ...
            [CosmosDB(databaseName:@"ratingsdb", collectionName:@"ratingscontainer", ConnectionStringSetting = @"RatingsDatabase")] IEnumerable<RatingModel> allRatings)
        {
            string userId = null;
